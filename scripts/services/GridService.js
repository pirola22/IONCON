    ...
    (function (application) {
        var GridService = (function () {
            ...
            GridService.prototype.clearGridStates = function () {
                var _this = this;
                var gridIds = ["sampleGrid1", "IONCONListGrid", "customerMasterListGrid", "itemGroupListGrid"];
            ...
            GridService.prototype.getIONCONListGrid = function () {
                var IONCONListGrid = angular.copy(this.baseGrid);
                var gridLinkCellTemplate = "<div class=\"ui-grid-cell-contents\"><span class=\"h5-link\" ng-click=\"grid.appScope.IONCONModule.loadIONCONRecordModule(col.field, row.entity)\" title=\"Constants\" >{{COL_FIELD CUSTOM_FILTERS}}</span></div>";
                IONCONListGrid.columnDefs =
                    [
                ...
                IONCONListGrid.exporterCsvFilename = "sample_list.csv";
                IONCONListGrid.exporterPdfFilename = "sample_list.pdf";
                IONCONListGrid.saveSelection = false;
                return IONCONListGrid;
            };
